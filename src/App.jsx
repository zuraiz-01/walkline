...
const fallbackCatalog = {
  ...
  hero: {
    ...
    image: 'https://source.unsplash.com/featured/900x1100?leather-wallet',
    tiles: [
  ...
  categories: [
    {
      ...
      image: 'https://source.unsplash.com/featured/800x800?wallet&sig=11',
      to: '/collections/wallets',
    },
    {
      title: 'Slim Card Holders',
      image: 'https://source.unsplash.com/featured/800x800?card-holder&sig=12',
      to: '/collections/wallets',
    },
    {
      title: 'Travel Wallets',
      image: 'https://source.unsplash.com/featured/800x800?passport-wallet&sig=13',
      to: '/collections/wallets',
    },
    {
      title: 'Keychains',
      image: 'https://source.unsplash.com/featured/800x800?keychain&sig=14',
  ...
  products: [
    {
      ...
      tag: 'Save 25%',
      image: 'https://source.unsplash.com/featured/800x1000?leather-wallet&sig=1',
      hoverImage: 'https://source.unsplash.com/featured/800x1000?wallet&sig=2',
    },
    {
      ...
      tag: 'New',
      image: 'https://source.unsplash.com/featured/800x1000?card-holder&sig=3',
      hoverImage: 'https://source.unsplash.com/featured/800x1000?minimal-wallet&sig=4',
    },
    {
      ...
      tag: 'Best seller',
      image: 'https://source.unsplash.com/featured/800x1000?bifold-wallet&sig=5',
      hoverImage: 'https://source.unsplash.com/featured/800x1000?leather&sig=6',
    },
    {
      ...
      tag: 'Sale',
      image: 'https://source.unsplash.com/featured/800x1000?coin-wallet&sig=7',
      hoverImage: 'https://source.unsplash.com/featured/800x1000?zip-wallet&sig=8',
    },
    {
      ...
      tag: 'Trending',
      image: 'https://source.unsplash.com/featured/800x1000?travel-wallet&sig=9',
      hoverImage: 'https://source.unsplash.com/featured/800x1000?passport&sig=10',
    },
    {
      ...
      tag: 'Restock',
      image: 'https://source.unsplash.com/featured/800x1000?minimal-wallet&sig=15',
      hoverImage: 'https://source.unsplash.com/featured/800x1000?wallet-leather&sig=16',
    },
    {
      ...
      tag: 'New',
      image: 'https://source.unsplash.com/featured/800x1000?keychain&sig=17',
      hoverImage: 'https://source.unsplash.com/featured/800x1000?keys&sig=18',
    },
    {
      ...
      compareAt: 'Rs.900.00',
      tag: 'Sale',
      image: 'https://source.unsplash.com/featured/800x1000?keyring&sig=19',
      hoverImage: 'https://source.unsplash.com/featured/800x1000?metal-keychain&sig=20',
    },
  ],
  promos: [
    {
      ...
      image: 'https://source.unsplash.com/featured/900x1100?wallet&sig=21',
    },
    {
      tag: 'NEW IN',
      title: 'Keychain Atelier',
      copy: 'Fresh hardware finishes and minimal straps.',
      image: 'https://source.unsplash.com/featured/900x1100?keychain&sig=22',
    },
    {
      tag: 'SIGNATURE',
      title: 'Everyday Carry',
      copy: 'Clean lines and premium leather texture.',
      image: 'https://source.unsplash.com/featured/900x1100?leather&sig=23',
    },
  ],
  trending: [
    {
      ...
      compareAt: 'Rs.4,200.00',
      tag: 'Hot',
      image: 'https://source.unsplash.com/featured/800x1000?passport-wallet&sig=24',
      hoverImage: 'https://source.unsplash.com/featured/800x1000?travel-wallet&sig=25',
    },
    {
      name: 'Classic Leather Wallet - Black',
      price: 'Rs.2,450.00',
      compareAt: 'Rs.3,200.00',
      tag: 'Trending',
      image: 'https://source.unsplash.com/featured/800x1000?leather-wallet&sig=26',
      hoverImage: 'https://source.unsplash.com/featured/800x1000?wallet&sig=27',
    },
    {
      name: 'Braided Leather Keychain - Black',
      price: 'Rs.850.00',
      compareAt: 'Rs.1,200.00',
      tag: 'Restock',
      image: 'https://source.unsplash.com/featured/800x1000?keys&sig=28',
      hoverImage: 'https://source.unsplash.com/featured/800x1000?keychain&sig=29',
    },
    {
      name: 'Minimalist Wallet - Grey',
      price: 'Rs.1,950.00',
      compareAt: 'Rs.2,600.00',
      tag: 'Sale',
      image: 'https://source.unsplash.com/featured/800x1000?minimal-wallet&sig=30',
      hoverImage: 'https://source.unsplash.com/featured/800x1000?wallet-leather&sig=31',
    },
  ],
  ...
  story: {
    ...
    image: 'https://source.unsplash.com/featured/1400x900?leather-craft',
  },
  newsletter: {
